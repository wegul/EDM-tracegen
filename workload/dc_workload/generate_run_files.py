...
delay = float(sys.argv[3])*1e-9
load = sys.argv[4]

folder = "workload/dc_workload/all-to-all-144-"+workload
f = open(folder+"/"+"conf-run-"+str(bandwidth)+"G-"+sys.argv[3]+"ns-"+load+".txt", "w")

f.write("init_cwnd: 12\n")
f.write("max_cwnd: 15\n")
f.write("retx_timeout: 45e-06\n")
f.write("queue_size: 36864\n")
f.write("propagation_delay: "+str(delay)+"\n")
f.write("bandwidth: " + str(bandwidth*1000000000.0) + "\n")
f.write("queue_type: 2\n")
f.write("flow_type: 2\n")
f.write("num_flow: 1000000\n")
f.write("flow_trace: "+folder+"/"+"trace-"+str(bandwidth)+"G-"+load+".csv\n")
f.write("cut_through: 0\n")
